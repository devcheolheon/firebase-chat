...
const Chatting = () => {
  ...
  const [userRelationData, loadedUserRelationData] = useUserRelationData({
    timeDiff: 1000,
  });
  const [userStackedData, loadedUserStackedData] = useUsersStackedData({
    timeDiff: 1000,
  });
